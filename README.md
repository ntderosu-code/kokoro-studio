...
[Supertonic](https://github.com/supertone-inc/supertonic) fast multilingual TTS via
...
- **Supertonic engine** — fast multilingual TTS with ten built-in voice styles
...
- **[Supertonic](https://github.com/supertone-inc/supertonic)** by Supertone —
  the fast on-device TTS engine (MIT; INT8 ONNX packaging by the
  sherpa-onnx project).
